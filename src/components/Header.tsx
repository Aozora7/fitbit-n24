            ...
            <p className="mt-1 text-sm text-gray-400">
                ...
                {circadianAnalysis.globalTau !== 24 && (
                    <>
                        ...
                        {(circadianAnalysis.globalDailyDrift * 60).toFixed(1)} min/day) &middot; Cumulative shift:{" "}
                        {cumulativeShiftDays >= 0 ? "+" : ""}
                        {cumulativeShiftDays.toFixed(1)} days over {daySpan} days &middot; Avg sleep:{" "}
                        {avgSleepPerDay.toFixed(1)}h/day &middot; Time in bed: {avgTimeInBedPerDay.toFixed(1)}h/day
                    </>
                )}
            </p>
